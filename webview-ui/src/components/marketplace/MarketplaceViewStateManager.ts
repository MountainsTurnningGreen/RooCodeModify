 ...
 *
 * This class manages the state for the marketplace view in the CryptContinue extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the CryptContinue extensions interface
